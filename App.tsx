    ...
    return (
        <div className={`${className} relative flex items-center justify-center select-none`}>
             <style>{`
                ...
                @keyframes eye-flash {
                    0%, 90% { opacity: 1; fill: #FFFFFF; filter: drop-shadow(0 0 2px rgba(255,255,255,0.8)); }
                    92% { opacity: 0.5; fill: #FFAAAA; }
                    94% { opacity: 1; fill: #FFFFFF; filter: drop-shadow(0 0 8px rgba(255,255,255,1)); }
                }
                @keyframes draw-fast {
                ...
                .dragon-body-main {
                    ...
                    stroke-dashoffset: 0;
                    animation: draw-fast 2s cubic-bezier(0.4, 0, 0.2, 1) forwards, breathe-heavy 4s ease-in-out infinite;
                    transform-origin: center;
                }
                .dragon-eye-real {
                    animation: eye-flash 5s infinite;
                }
                .dragon-grad-anim {
                    animation: magma-flow 3s infinite alternate;
                }
            `}</style>
            <div className="w-full h-full filter drop-shadow-md">
                <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="dragon-magma" x1="0%" y1="0%" x2="100%" y2="100%" className="dragon-grad-anim">
                            <stop offset="0%" stopColor="#ef4444" />   {/* Red 500 */}
                            <stop offset="40%" stopColor="#b91c1c" />   {/* Red 700 */}
                            <stop offset="60%" stopColor="#dc2626" />   {/* Red 600 */}
                            <stop offset="100%" stopColor="#7f1d1d" />  {/* Red 900 */}
                        </linearGradient>
                    </defs>

                    {/* Accurate Tribal Dragon Path */}
                    <path 
                        d="M 85 30 
                           C 82 25, 75 15, 60 12 
                           C 45 9, 30 15, 20 25 
                           ...
                           C 75 26, 80 35, 85 30 
                           Z" 
                        fill="url(#dragon-magma)" 
                        stroke="#7f1d1d"
                        strokeWidth="0.5"
                        className="dragon-body-main"
                    />
                    
                    {/* Sharp Horn/Mane Accents */}
                    <path 
                        d="M 60 12 C 65 5, 75 5, 85 10 C 80 12, 75 15, 72 18" 
                        fill="url(#dragon-magma)" 
                        className="dragon-body-main"
                        style={{ animationDelay: '0.1s' }}
                    />
                    
                     {/* Lower Jaw/Snout Detail */}
                     <path 
                        d="M 75 75 C 85 65, 90 50, 85 40 L 78 45 C 82 55, 75 65, 75 75 Z"
                        fill="url(#dragon-magma)"
                        className="dragon-body-main"
                    ...
                    {/* Realistic Eye */}
                    <path 
                        d="M 72 26 L 76 24 L 76 28 Z" 
                        fill="white" 
                        className="dragon-eye-real" 
                    />
                </svg>
            </div>
        </div>
